...
parser.add_argument("--num_samples", type=int, default=16, help="number of iterations")
...
loss_function = DOMINO_PlusPlus() ##DiceCELoss(to_onehot_y=True, softmax=True) ##DOMINOLoss_fast() ##criterion()#DiceCELoss(to_onehot_y=True, softmax=True)
